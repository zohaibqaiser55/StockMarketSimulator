...
public class StockSimulator {
	...
	private void genDynamicData() {
		companies.addAll(DynamicData.genCompanies(NUMBER));
		investors.addAll(DynamicData.genInvestors(NUMBER));
		
		System.out.println("Total Shares " + DynamicData.totalShares);
		System.out.println("Total Money " + DynamicData.totalMoney);
	}
